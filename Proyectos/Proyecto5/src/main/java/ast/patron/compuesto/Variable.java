...
public class Variable{
    ...
    public Variable(boolean val){bval=val;}
    /**Initialize me as an int*/
    public Variable(int val){ival=val;}
    /**Initialize me as a double*/
    public Variable(double val){dval=val;}
    /**Initialize me as a string*/
    public Variable(String val){sval=val;}
    /**Initialize me as an Object*/
    public Variable(Object val){obj=val;}
}//end class
//#############################################
//## E N D    O F    F I L E
//#############################################
